...
> **VisionSpace**에서 풀스택 엔지니어 · AI 플랫폼 개발 리딩 역할로
> 물류창고 설비 데이터를 실시간 수집·시각화·분석하는 하이브리드 클라우드
> 플랫폼을 개발했습니다.
...
| --- | --- |
| LLM 워크플로 · RAG · VectorDB · 프롬프트 인젝션 회귀 테스트 · 런타임 트레이스 · 토큰 및 비용 신호 | Python · FastAPI · Java · Spring Boot · Kafka · RabbitMQ · Kinesis · PostgreSQL |
